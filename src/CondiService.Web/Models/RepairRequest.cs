...
public class RepairRequest
{
    ...
    [Display(Name = "Срок выполнения (дедлайн)")]
    public DateTime DueAt { get; set; } = DateTime.UtcNow.AddDays(3);

    [Display(Name = "Согласовано продление с заказчиком")]
    public bool DueExtensionApproved { get; set; }

    [StringLength(300)]
    [Display(Name = "Комментарий к продлению")]
    public string? DueExtensionComment { get; set; }
